...
if __name__ == '__main__':
    ...
    # parser.add_argument('--restore_ckpt', help="restore checkpoint", default='/root/autodl-tmp/stereo/logs/ckpt_output/igev_edge_pt_2_6_best_epe0.9309_step67000.pth')
    # parser.add_argument('--restore_ckpt', help="restore checkpoint", default='/root/autodl-tmp/stereo/logs/ckpt_output/igev_edge_pt_2_6_best_epe0.7722_step156000.pth')
    # parser.add_argument('--restore_ckpt', help="restore checkpoint", default='/root/autodl-tmp/stereo/logs/edge_d1_26/174500_igev_edge_pt_2_6.pth')
    parser.add_argument('--restore_ckpt', help="restore checkpoint", default='/root/autodl-tmp/stereo/logs/edge_d1_26/180000_igev_edge_pt_2_6.pth')
